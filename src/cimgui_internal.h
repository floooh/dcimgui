...
struct ImGuiContext_t
{
    ...
    // Viewports
    ImVector_ImGuiViewportPPtr     Viewports;                           // Active viewports (Size==1 in 'master' branch). Each viewports hold their copy of ImDrawData.
...
CIMGUI_API ImDrawList* igGetForegroundDrawListImGuiWindowPtr(ImGuiWindow* window);            // This seemingly unnecessary wrapper simplifies compatibility between the 'master' and 'docking' branches.
CIMGUI_API ImDrawList* igGetBackgroundDrawListImGuiViewportPtr(ImGuiViewport* viewport);      // get background draw list for the given viewport. this draw list will be the first rendering one. Useful to quickly draw shapes/text behind dear imgui contents.
CIMGUI_API ImDrawList* igGetForegroundDrawListImGuiViewportPtr(ImGuiViewport* viewport);      // get foreground draw list for the given viewport. this draw list will be the last rendered one. Useful to quickly draw shapes/text over dear imgui contents.
...
// Viewports
CIMGUI_API ImGuiViewport* igGetWindowViewport(void);                                               // For code consistency. This is public API in docking branch.
...
CIMGUI_API bool    igCollapseButton(ImGuiID id, ImVec2 pos);

...
// Fonts, drawing
CIMGUI_API void        igRegisterUserTexture(ImTextureData* tex);                           // Register external texture. EXPERIMENTAL: DO NOT USE YET.
...
CIMGUI_API void             igOpenPopupEx(ImGuiID id);                                                                       // Implied popup_flags = ImGuiPopupFlags_None
CIMGUI_API void             igOpenPopupExEx(ImGuiID id, ImGuiPopupFlags popup_flags /* = ImGuiPopupFlags_None */);
...
CIMGUI_API void               igSetItemKeyOwnerImGuiInputFlags(ImGuiKey key, ImGuiInputFlags flags);      // Set key owner to last item if it is hovered or active. Equivalent to 'if (IsItemHovered() || IsItemActive()) { SetKeyOwner(key, GetItemID());'.
...
CIMGUI_API void        igRenderNavCursor(ImRect bb, ImGuiID id);                                                                                                         // Implied flags = ImGuiNavRenderCursorFlags_None
CIMGUI_API void        igRenderNavCursorEx(ImRect bb, ImGuiID id, ImGuiNavRenderCursorFlags flags /* = ImGuiNavRenderCursorFlags_None */);                               // Navigation highlight
#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS

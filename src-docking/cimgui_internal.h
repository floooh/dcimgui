...
CIMGUI_API void  igTableOpenContextMenu(void);                           // Implied column_n = -1
CIMGUI_API void  igTableOpenContextMenuEx(int column_n /* = -1 */);
...
CIMGUI_API int   igTableGetHoveredRow(void);                             // Retrieve *PREVIOUS FRAME* hovered row. This difference with TableGetHoveredColumn() is the reason why this is not public yet.
...
CIMGUI_API bool                    igBeginTableWithID(const char* name, ImGuiID id, int columns_count, ImGuiTableFlags flags /* = 0 */); // Implied outer_size = ImVec2(0, 0), inner_width = 0.0f
CIMGUI_API bool                    igBeginTableWithIDEx(const char* name, ImGuiID id, int columns_count, ImGuiTableFlags flags /* = 0 */, ImVec2 outer_size /* = ImVec2(0, 0) */, float inner_width /* = 0.0f */);
...
CIMGUI_API ImRect                  igTableGetCellBgRect(const ImGuiTable* table, int column_n);
CIMGUI_API const char*             igTableGetColumnNameImGuiTablePtr(const ImGuiTable* table, int column_n);
CIMGUI_API ImGuiID                 igTableGetColumnResizeID(ImGuiTable* table, int column_n);                                           // Implied instance_no = 0
CIMGUI_API ImGuiID                 igTableGetColumnResizeIDEx(ImGuiTable* table, int column_n, int instance_no /* = 0 */);
...
CIMGUI_API void                    igTableGcCompactTransientBuffersImGuiTableTempDataPtr(ImGuiTableTempData* table);
...
CIMGUI_API void             igSetWindowClipRectBeforeSetChannel(ImGuiWindow* window, ImRect clip_rect);
CIMGUI_API void             igBeginColumns(const char* str_id, int count, ImGuiOldColumnFlags flags /* = 0 */);      // setup number of columns. use an identifier to distinguish multiple column sets. close with EndColumns().
CIMGUI_API void             igEndColumns(void);                                                                      // close columns
...
CIMGUI_API ImGuiIO*         igGetIOImGuiContextPtr(ImGuiContext* ctx);
CIMGUI_API ImGuiPlatformIO* igGetPlatformIOImGuiContextPtr(ImGuiContext* ctx);
CIMGUI_API float            igGetScale(void);                                                                                       // FIXME-DPI: I don't want to formalize this just yet. Because reasons. Please don't use.
...
CIMGUI_API void             igSetWindowPosImGuiWindowPtr(ImGuiWindow* window, ImVec2 pos, ImGuiCond cond /* = 0 */);
CIMGUI_API void             igSetWindowSizeImGuiWindowPtr(ImGuiWindow* window, ImVec2 size, ImGuiCond cond /* = 0 */);
CIMGUI_API void             igSetWindowCollapsedImGuiWindowPtr(ImGuiWindow* window, bool collapsed, ImGuiCond cond /* = 0 */);
CIMGUI_API void             igSetWindowHitTestHole(ImGuiWindow* window, ImVec2 pos, ImVec2 size);
CIMGUI_API void             igSetWindowHiddenAndSkipItemsForCurrentFrame(ImGuiWindow* window);
CIMGUI_API void             igSetWindowParentWindowForFocusRoute(ImGuiWindow* window, ImGuiWindow* parent_window);                  // You may also use SetNextWindowClass()'s FocusRouteParentWindowId field.
CIMGUI_API ImRect           igWindowRectAbsToRel(ImGuiWindow* window, ImRect r);
CIMGUI_API ImRect           igWindowRectRelToAbs(ImGuiWindow* window, ImRect r);
CIMGUI_API ImVec2           igWindowPosAbsToRel(ImGuiWindow* window, ImVec2 p);
CIMGUI_API ImVec2           igWindowPosRelToAbs(ImGuiWindow* window, ImVec2 p);

// Windows: Display Order and Focus Order
CIMGUI_API void         igFocusWindow(ImGuiWindow* window, ImGuiFocusRequestFlags flags /* = 0 */);
...
// Fonts, drawing
CIMGUI_API void        igRegisterUserTexture(ImTextureData* tex);                           // Register external texture. EXPERIMENTAL.
...
CIMGUI_API ImDrawList* igGetForegroundDrawListImGuiWindowPtr(ImGuiWindow* window);
...
CIMGUI_API void igShutdown(void);      // Since 1.60 this is a _private_ function. You can call DestroyContext() to destroy the context created by CreateContext().
...
CIMGUI_API void igUpdateHoveredWindowAndCaptureFlags(ImVec2 mouse_pos);
CIMGUI_API void igFindHoveredWindowEx(ImVec2 pos, bool find_first_and_in_any_viewport, ImGuiWindow** out_hovered_window, ImGuiWindow** out_hovered_window_under_moving_window);
...
// Viewports
CIMGUI_API void                        igTranslateWindowsInViewport(ImGuiViewportP* viewport, ImVec2 old_pos, ImVec2 new_pos, ImVec2 old_size, ImVec2 new_size);
...
CIMGUI_API ImGuiViewportP*             igFindHoveredViewportFromPlatformWindowStack(ImVec2 mouse_platform_pos);

// Settings
CIMGUI_API void                  igMarkIniSettingsDirty(void);
CIMGUI_API void                  igMarkIniSettingsDirtyImGuiWindowPtr(ImGuiWindow* window);
CIMGUI_API void                  igClearIniSettings(void);
CIMGUI_API void                  igCleanupIniSettings(ImGuiSettingsCleanupArgs* args);           // [BETA] Expected to turn into a public API. Please report if you are using this!
...
// Scrolling
CIMGUI_API void igSetScrollXImGuiWindowPtr(ImGuiWindow* window, float scroll_x);
CIMGUI_API void igSetScrollYImGuiWindowPtr(ImGuiWindow* window, float scroll_y);
CIMGUI_API void igSetScrollFromPosXImGuiWindowPtr(ImGuiWindow* window, float local_x, float center_x_ratio);
CIMGUI_API void igSetScrollFromPosYImGuiWindowPtr(ImGuiWindow* window, float local_y, float center_y_ratio);

// Early work-in-progress API (ScrollToItem() will become public)
CIMGUI_API void   igScrollToItem(ImGuiScrollFlags flags /* = 0 */);
CIMGUI_API void   igScrollToRect(ImGuiWindow* window, ImRect rect, ImGuiScrollFlags flags /* = 0 */);
CIMGUI_API ImVec2 igScrollToRectEx(ImGuiWindow* window, ImRect rect, ImGuiScrollFlags flags /* = 0 */);
//#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
CIMGUI_API void   igScrollToBringRectIntoView(ImGuiWindow* window, ImRect rect);
//#endif
...
CIMGUI_API void                 igMarkItemEdited(ImGuiID id);                                                            // Mark data associated to given item as "edited", used by IsItemDeactivatedAfterEdit() function.
CIMGUI_API void                 igPushOverrideID(ImGuiID id);                                                            // Push given value as-is at the top of the ID stack (whereas PushID combines old and new hashes)
CIMGUI_API ImGuiID              igGetIDWithSeedStr(const char* str_id_begin, const char* str_id_end, ImGuiID seed);
CIMGUI_API ImGuiID              igGetIDWithSeed(int n, ImGuiID seed);

// Basic Helpers for widget code
CIMGUI_API void   igItemSize(ImVec2 size);                                                                          // Implied text_baseline_y = -1.0f
CIMGUI_API void   igItemSizeEx(ImVec2 size, float text_baseline_y /* = -1.0f */);
CIMGUI_API void   igItemSizeImRect(ImRect bb);                                                                      // Implied text_baseline_y = -1.0f
CIMGUI_API void   igItemSizeImRectEx(ImRect bb, float text_baseline_y /* = -1.0f */);                               // FIXME: This is a misleading API since we expect CursorPos to be bb.Min.
CIMGUI_API bool   igItemAdd(ImRect bb, ImGuiID id);                                                                 // Implied nav_bb = NULL, extra_flags = 0
CIMGUI_API bool   igItemAddEx(ImRect bb, ImGuiID id, const ImRect* nav_bb /* = NULL */, ImGuiItemFlags extra_flags /* = 0 */);
CIMGUI_API bool   igItemHoverable(ImRect bb, ImGuiID id, ImGuiItemFlags item_flags);
CIMGUI_API bool   igIsWindowContentHoverable(ImGuiWindow* window, ImGuiHoveredFlags flags /* = 0 */);
CIMGUI_API bool   igIsClippedEx(ImRect bb, ImGuiID id);
CIMGUI_API void   igSetLastItemData(ImGuiID item_id, ImGuiItemFlags item_flags, ImGuiItemStatusFlags status_flags, ImRect item_rect);
CIMGUI_API ImVec2 igCalcItemSize(ImVec2 size, float default_w, float default_h);
...
// Logging/Capture
CIMGUI_API void igLogBegin(ImGuiLogFlags flags, int auto_open_depth);                                                 // -> BeginCapture() when we design v2 api, for now stay under the radar by using the old name.
CIMGUI_API void igLogToBuffer(void);                                                                                  // Implied auto_open_depth = -1
CIMGUI_API void igLogToBufferEx(int auto_open_depth /* = -1 */);                                                      // Start logging/capturing to internal buffer
CIMGUI_API void igLogRenderedText(const ImVec2* ref_pos, const char* text);                                           // Implied text_end = NULL
CIMGUI_API void igLogRenderedTextEx(const ImVec2* ref_pos, const char* text, const char* text_end /* = NULL */);
CIMGUI_API void igLogSetNextTextDecoration(const char* prefix, const char* suffix);

// Childs
CIMGUI_API bool         igBeginChildEx(const char* name, ImGuiID id, ImVec2 size_arg, ImGuiChildFlags child_flags, ImGuiWindowFlags window_flags);
...
CIMGUI_API bool             igOpenPopupEx(ImGuiID id);                                                                       // Implied popup_flags = ImGuiPopupFlags_None
CIMGUI_API bool             igOpenPopupExEx(ImGuiID id, ImGuiPopupFlags popup_flags /* = ImGuiPopupFlags_None */);
...
CIMGUI_API ImRect           igGetPopupAllowedExtentRect(ImGuiWindow* window);
...
CIMGUI_API ImVec2           igFindBestWindowPosForPopup(ImGuiWindow* window);
CIMGUI_API ImVec2           igFindBestWindowPosForPopupEx(ImVec2 ref_pos, ImVec2 size, ImGuiDir* last_dir, ImRect r_outer, ImRect r_avoid, ImGuiPopupPositionPolicy policy);
...
CIMGUI_API bool igBeginMenuWithIcon(const char* label, const char* icon);                                   // Implied enabled = true
CIMGUI_API bool igBeginMenuWithIconEx(const char* label, const char* icon, bool enabled /* = true */);
CIMGUI_API bool igMenuItemWithIcon(const char* label, const char* icon);                                    // Implied shortcut = NULL, selected = false, enabled = true
CIMGUI_API bool igMenuItemWithIconEx(const char* label, const char* icon, const char* shortcut /* = NULL */, bool selected /* = false */, bool enabled /* = true */);

// Combos
CIMGUI_API bool igBeginComboPopup(ImGuiID popup_id, ImRect bb, ImGuiComboFlags flags);
...
CIMGUI_API void igSetNavID(ImGuiID id, ImGuiNavLayer nav_layer, ImGuiID focus_scope_id, ImRect rect_rel);
CIMGUI_API void igSetNavFocusScope(ImGuiID focus_scope_id);

// Focus/Activation
// This should be part of a larger set of API: FocusItem(offset = -1), FocusItemByID(id), ActivateItem(offset = -1), ActivateItemByID(id) etc. which are
// much harder to design and implement than expected. I have a couple of private branches on this matter but it's not simple. For now implementing the easy ones.
CIMGUI_API void igFocusItem(void);                   // Focus last item (no selection/activation).
CIMGUI_API void igActivateItemByID(ImGuiID id);      // Activate an item by ID (button, checkbox, tree node etc.). Activation is queued and processed on the next frame when the item is encountered again. Was called 'ActivateItem()' before 1.89.7.
...
CIMGUI_API ImGuiKeyData* igGetKeyDataImGuiContextPtr(ImGuiContext* ctx, ImGuiKey key);
...
CIMGUI_API bool          igIsMouseDragPastThreshold(ImGuiMouseButton button);                                                 // Implied lock_threshold = -1.0f
CIMGUI_API bool          igIsMouseDragPastThresholdEx(ImGuiMouseButton button, float lock_threshold /* = -1.0f */);
CIMGUI_API ImVec2        igGetKeyMagnitude2d(ImGuiKey key_left, ImGuiKey key_right, ImGuiKey key_up, ImGuiKey key_down);
...
CIMGUI_API void          igTeleportMousePos(ImVec2 pos);
...
CIMGUI_API void               igSetKeyOwner(ImGuiKey key, ImGuiID owner_id, ImGuiInputFlags flags /* = 0 */);
CIMGUI_API void               igSetKeyOwnersForKeyChord(ImGuiKeyChord key, ImGuiID owner_id, ImGuiInputFlags flags /* = 0 */);
CIMGUI_API bool               igSetItemKeyOwnerImGuiInputFlags(ImGuiKey key, ImGuiInputFlags flags);
CIMGUI_API bool               igTestKeyOwner(ImGuiKey key, ImGuiID owner_id);          // Test that key is either not owned, either owned by 'owner_id'
...
CIMGUI_API bool igIsMouseDownID(ImGuiMouseButton button, ImGuiID owner_id);
CIMGUI_API bool igIsMouseClickedImGuiInputFlags(ImGuiMouseButton button, ImGuiInputFlags flags);                                       // Implied owner_id = 0
CIMGUI_API bool igIsMouseClickedImGuiInputFlagsEx(ImGuiMouseButton button, ImGuiInputFlags flags, ImGuiID owner_id /* = 0 */);
CIMGUI_API bool igIsMouseReleasedID(ImGuiMouseButton button, ImGuiID owner_id);
CIMGUI_API bool igIsMouseDoubleClickedID(ImGuiMouseButton button, ImGuiID owner_id);
...
CIMGUI_API bool                 igShortcutID(ImGuiKeyChord key_chord, ImGuiInputFlags flags, ImGuiID owner_id);
CIMGUI_API bool                 igSetShortcutRouting(ImGuiKeyChord key_chord, ImGuiInputFlags flags, ImGuiID owner_id);      // owner_id needs to be explicit and cannot be 0
...
CIMGUI_API void           igDockContextClearNodes(ImGuiContext* ctx, ImGuiID root_id, bool clear_settings_refs);                  // Use root_id==0 to clear all
...
CIMGUI_API void           igDockContextProcessUndockWindow(ImGuiContext* ctx, ImGuiWindow* window);                               // Implied clear_persistent_docking_ref = true
CIMGUI_API void           igDockContextProcessUndockWindowEx(ImGuiContext* ctx, ImGuiWindow* window, bool clear_persistent_docking_ref /* = true */);
...
CIMGUI_API ImGuiID        igDockBuilderAddNode(void);                                                                                   // Implied node_id = 0, flags = 0
CIMGUI_API ImGuiID        igDockBuilderAddNodeEx(ImGuiID node_id /* = 0 */, ImGuiDockNodeFlags flags /* = 0 */);
CIMGUI_API void           igDockBuilderRemoveNode(ImGuiID node_id);                                                                     // Remove node and all its child, undock all windows
CIMGUI_API void           igDockBuilderRemoveNodeDockedWindows(ImGuiID node_id);                                                        // Implied clear_settings_refs = true
CIMGUI_API void           igDockBuilderRemoveNodeDockedWindowsEx(ImGuiID node_id, bool clear_settings_refs /* = true */);
CIMGUI_API void           igDockBuilderRemoveNodeChildNodes(ImGuiID node_id);                                                           // Remove all split/hierarchy. All remaining docked windows will be re-docked to the remaining root node (node_id).
...
CIMGUI_API ImGuiID        igDockBuilderSplitNode(ImGuiID node_id, ImGuiDir split_dir, float size_ratio_for_node_at_dir, ImGuiID* out_id_at_dir, ImGuiID* out_id_at_opposite_dir); // Create 2 child nodes in this parent node.
...
CIMGUI_API ImGuiID igGetCurrentFocusScope(void);      // Focus scope we are outputting into, set by PushFocusScope()
...
CIMGUI_API void igRenderDragDropTargetRectEx(ImDrawList* draw_list, ImRect bb, float rounding);
...
CIMGUI_API ImGuiTypingSelectRequest* igGetTypingSelectRequest(void);                                                                                                                                 // Implied flags = ImGuiTypingSelectFlags_None
CIMGUI_API ImGuiTypingSelectRequest* igGetTypingSelectRequestEx(ImGuiTypingSelectFlags flags /* = ImGuiTypingSelectFlags_None */);
...
// Box-Select API
CIMGUI_API bool igBeginBoxSelect(ImRect scope_rect, ImGuiWindow* window, ImGuiID box_select_id, ImGuiMultiSelectFlags ms_flags);
CIMGUI_API void igEndBoxSelect(ImRect scope_rect, ImGuiMultiSelectFlags ms_flags);

// Multi-Select API
CIMGUI_API void                   igMultiSelectItemHeader(ImGuiID id, bool* p_selected, ImGuiButtonFlags* p_button_flags);
CIMGUI_API void                   igMultiSelectItemFooter(ImGuiID id, bool* p_selected, bool* p_pressed);                                                     // Implied extra_flags = 0
CIMGUI_API void                   igMultiSelectItemFooterEx(ImGuiID id, bool* p_selected, bool* p_pressed, ImGuiMultiSelectFlags extra_flags /* = 0 */);
...
CIMGUI_API void          igTabBarQueueFocusStr(ImGuiTabBar* tab_bar, const char* tab_name);
...
CIMGUI_API ImVec2        igTabItemCalcSizeStr(const char* label, bool has_close_button_or_unsaved_marker);
CIMGUI_API ImVec2        igTabItemCalcSize(ImGuiWindow* window);
CIMGUI_API void          igTabItemBackground(ImDrawList* draw_list, ImRect bb, ImGuiTabItemFlags flags, ImU32 col);
CIMGUI_API void          igTabItemLabelAndCloseButton(ImDrawList* draw_list, ImRect bb, ImGuiTabItemFlags flags, ImVec2 frame_padding, const char* label, ImGuiID tab_id, ImGuiID close_button_id, bool is_contents_visible, bool* out_just_closed, bool* out_text_clipped);

// Render helpers
// AVOID USING OUTSIDE OF IMGUI.CPP! NOT FOR PUBLIC CONSUMPTION. THOSE FUNCTIONS ARE A MESS. THEIR SIGNATURE AND BEHAVIOR WILL CHANGE, THEY NEED TO BE REFACTORED INTO SOMETHING DECENT.
// NB: All position are in absolute pixels coordinates (we are never using window coordinates internally)
CIMGUI_API void        igRenderText(ImVec2 pos, const char* text);                                                                                                            // Implied text_end = NULL, hide_text_after_hash = true
CIMGUI_API void        igRenderTextEx(ImVec2 pos, const char* text, const char* text_end /* = NULL */, bool hide_text_after_hash /* = true */);
CIMGUI_API void        igRenderTextWrapped(ImVec2 pos, const char* text, const char* text_end, float wrap_width);
CIMGUI_API void        igRenderTextClipped(ImVec2 pos_min, ImVec2 pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known);                         // Implied align = ImVec2(0, 0), clip_rect = NULL
CIMGUI_API void        igRenderTextClippedEx(ImVec2 pos_min, ImVec2 pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known, ImVec2 align /* = ImVec2(0, 0) */, const ImRect* clip_rect /* = NULL */);
CIMGUI_API void        igRenderTextClippedWithDrawList(ImDrawList* draw_list, ImVec2 pos_min, ImVec2 pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known); // Implied align = ImVec2(0, 0), clip_rect = NULL
CIMGUI_API void        igRenderTextClippedWithDrawListEx(ImDrawList* draw_list, ImVec2 pos_min, ImVec2 pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known, ImVec2 align /* = ImVec2(0, 0) */, const ImRect* clip_rect /* = NULL */);
CIMGUI_API void        igRenderTextEllipsis(ImDrawList* draw_list, ImVec2 pos_min, ImVec2 pos_max, float ellipsis_max_x, const char* text, const char* text_end, const ImVec2* text_size_if_known);
CIMGUI_API void        igRenderFrame(ImVec2 p_min, ImVec2 p_max, ImU32 fill_col);                                                                                             // Implied borders = true, rounding = 0.0f
CIMGUI_API void        igRenderFrameEx(ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, bool borders /* = true */, float rounding /* = 0.0f */);
CIMGUI_API void        igRenderFrameBorder(ImVec2 p_min, ImVec2 p_max);                                                                                                       // Implied rounding = 0.0f
CIMGUI_API void        igRenderFrameBorderEx(ImVec2 p_min, ImVec2 p_max, float rounding /* = 0.0f */);
CIMGUI_API void        igRenderColorComponentMarker(ImRect bb, ImU32 col, float rounding);
CIMGUI_API void        igRenderColorRectWithAlphaCheckerboard(ImDrawList* draw_list, ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, float grid_step, ImVec2 grid_off);           // Implied rounding = 0.0f, flags = 0
CIMGUI_API void        igRenderColorRectWithAlphaCheckerboardEx(ImDrawList* draw_list, ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, float grid_step, ImVec2 grid_off, float rounding /* = 0.0f */, ImDrawFlags flags /* = 0 */);
CIMGUI_API void        igRenderNavCursor(ImRect bb, ImGuiID id);                                                                                                              // Implied flags = ImGuiNavRenderCursorFlags_None, rounding = -1.0f
CIMGUI_API void        igRenderNavCursorEx(ImRect bb, ImGuiID id, ImGuiNavRenderCursorFlags flags /* = ImGuiNavRenderCursorFlags_None */, float rounding /* = -1.0f */);      // Navigation highlight
#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
CIMGUI_API void igRenderNavHighlight(ImRect bb, ImGuiID id);                                                                                // Implied flags = ImGuiNavRenderCursorFlags_None
CIMGUI_API void igRenderNavHighlightEx(ImRect bb, ImGuiID id, ImGuiNavRenderCursorFlags flags /* = ImGuiNavRenderCursorFlags_None */);      // Renamed in 1.91.4
#endif // #ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
CIMGUI_API const char* igFindRenderedTextEnd(const char* text);                                                                                                               // Implied text_end = NULL
CIMGUI_API const char* igFindRenderedTextEndEx(const char* text, const char* text_end /* = NULL */);                                                                          // Find the optional ## from which we stop displaying text.
...
CIMGUI_API void        igRenderArrow(ImDrawList* draw_list, ImVec2 pos, ImU32 col, ImGuiDir dir);                                                    // Implied scale = 1.0f
CIMGUI_API void        igRenderArrowEx(ImDrawList* draw_list, ImVec2 pos, ImU32 col, ImGuiDir dir, float scale /* = 1.0f */);
...
CIMGUI_API void        igRenderRectFilledInRangeH(ImDrawList* draw_list, ImRect rect, ImU32 col, float fill_x0, float fill_x1, float rounding);
CIMGUI_API void        igRenderRectFilledWithHole(ImDrawList* draw_list, ImRect outer, ImRect inner, ImU32 col, float rounding);
CIMGUI_API ImDrawFlags igCalcRoundingFlagsForRectInRect(ImRect r_in, ImRect r_outer, float threshold);

// Widgets: Text
CIMGUI_API void igTextEx(const char* text);                                                                           // Implied text_end = NULL, flags = 0
CIMGUI_API void igTextExEx(const char* text, const char* text_end /* = NULL */, ImGuiTextFlags flags /* = 0 */);
CIMGUI_API void igTextAligned(float align_x, float size_x, const char* fmt, ...);                                     // FIXME-WIP: Works but API is likely to be reworked. This is designed for 1 item on the line. (#7024)
CIMGUI_API void igTextAlignedV(float align_x, float size_x, const char* fmt, va_list args);

// Widgets
CIMGUI_API bool igButtonWithFlags(const char* label);                                                                                // Implied size_arg = ImVec2(0, 0), flags = 0
CIMGUI_API bool igButtonWithFlagsEx(const char* label, ImVec2 size_arg /* = ImVec2(0, 0) */, ImGuiButtonFlags flags /* = 0 */);
CIMGUI_API bool igArrowButtonEx(const char* str_id, ImGuiDir dir, ImVec2 size_arg, ImGuiButtonFlags flags /* = 0 */);
CIMGUI_API bool igImageButtonWithFlags(ImGuiID id, ImTextureRef tex_ref, ImVec2 image_size, ImVec2 uv0, ImVec2 uv1, ImVec4 bg_col, ImVec4 tint_col, ImGuiButtonFlags flags /* = 0 */);
CIMGUI_API void igSeparatorEx(ImGuiSeparatorFlags flags);                                                                            // Implied thickness = 1.0f
CIMGUI_API void igSeparatorExEx(ImGuiSeparatorFlags flags, float thickness /* = 1.0f */);
CIMGUI_API void igSeparatorTextEx(ImGuiID id, const char* label, const char* label_end, float extra_width);
CIMGUI_API bool igCheckboxFlagsImS64Ptr(const char* label, ImS64* flags, ImS64 flags_value);
CIMGUI_API bool igCheckboxFlagsImU64Ptr(const char* label, ImU64* flags, ImU64 flags_value);

// Widgets: Window Decorations
CIMGUI_API bool    igCloseButton(ImGuiID id, ImVec2 pos);
CIMGUI_API bool    igCollapseButton(ImGuiID id, ImVec2 pos, ImGuiDockNode* dock_node);
CIMGUI_API void    igScrollbar(ImGuiAxis axis);
CIMGUI_API bool    igScrollbarEx(ImRect bb, ImGuiID id, ImGuiAxis axis, ImS64* p_scroll_v, ImS64 avail_v, ImS64 contents_v);      // Implied draw_rounding_flags = 0
CIMGUI_API bool    igScrollbarExEx(ImRect bb, ImGuiID id, ImGuiAxis axis, ImS64* p_scroll_v, ImS64 avail_v, ImS64 contents_v, ImDrawFlags draw_rounding_flags /* = 0 */);
CIMGUI_API ImRect  igGetWindowScrollbarRect(ImGuiWindow* window, ImGuiAxis axis);
CIMGUI_API ImGuiID igGetWindowScrollbarID(ImGuiWindow* window, ImGuiAxis axis);
CIMGUI_API ImGuiID igGetWindowResizeCornerID(ImGuiWindow* window, int n);                                                         // 0..3: corners
...
CIMGUI_API bool igButtonBehavior(ImRect bb, ImGuiID id, bool* out_hovered, bool* out_held, ImGuiButtonFlags flags /* = 0 */);
...
CIMGUI_API bool igSliderBehavior(ImRect bb, ImGuiID id, ImGuiDataType data_type, void* p_v, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags, ImRect* out_grab_bb);
CIMGUI_API bool igSplitterBehavior(ImRect bb, ImGuiID id, ImGuiAxis axis, float* size1, float* size2, float min_size1, float min_size2);      // Implied hover_extend = 0.0f, hover_visibility_delay = 0.0f, bg_col = 0
CIMGUI_API bool igSplitterBehaviorEx(ImRect bb, ImGuiID id, ImGuiAxis axis, float* size1, float* size2, float min_size1, float min_size2, float hover_extend /* = 0.0f */, float hover_visibility_delay /* = 0.0f */, ImU32 bg_col /* = 0 */);

// Widgets: Tree Nodes
CIMGUI_API bool igTreeNodeBehavior(ImGuiID id, ImGuiTreeNodeFlags flags, const char* label);      // Implied label_end = NULL
CIMGUI_API bool igTreeNodeBehaviorEx(ImGuiID id, ImGuiTreeNodeFlags flags, const char* label, const char* label_end /* = NULL */);
CIMGUI_API void igTreeNodeDrawLineToChildNode(ImVec2 target_pos);
...
CIMGUI_API bool igTreeNodeUpdateNextOpen(ImGuiID storage_id, ImGuiTreeNodeFlags flags);           // Return open state. Consume previous SetNextItemOpen() data, if any. May return true when logging.
...
CIMGUI_API bool                     igDataTypeApplyFromText(const char* buf, ImGuiDataType data_type, void* p_data, const char* format);      // Implied p_data_when_empty = NULL
CIMGUI_API bool                     igDataTypeApplyFromTextEx(const char* buf, ImGuiDataType data_type, void* p_data, const char* format, void* p_data_when_empty /* = NULL */);
...
// InputText
CIMGUI_API bool                 igInputTextWithHintAndSize(const char* label, const char* hint, char* buf, int buf_size, ImVec2 size_arg, ImGuiInputTextFlags flags);      // Implied callback = NULL, user_data = NULL
CIMGUI_API bool                 igInputTextWithHintAndSizeEx(const char* label, const char* hint, char* buf, int buf_size, ImVec2 size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback /* = NULL */, void* user_data /* = NULL */);
CIMGUI_API void                 igInputTextDeactivateHook(ImGuiID id);
CIMGUI_API bool                 igTempInputText(ImRect bb, ImGuiID id, const char* label, char* buf, size_t buf_size, ImGuiInputTextFlags flags /* = 0 */);                // Implied callback = NULL, user_data = NULL
CIMGUI_API bool                 igTempInputTextEx(ImRect bb, ImGuiID id, const char* label, char* buf, size_t buf_size, ImGuiInputTextFlags flags /* = 0 */, ImGuiInputTextCallback callback /* = NULL */, void* user_data /* = NULL */);
CIMGUI_API bool                 igTempInputScalar(ImRect bb, ImGuiID id, const char* label, ImGuiDataType data_type, void* p_data, const char* format);                    // Implied p_clamp_min = NULL, p_clamp_max = NULL
CIMGUI_API bool                 igTempInputScalarEx(ImRect bb, ImGuiID id, const char* label, ImGuiDataType data_type, void* p_data, const char* format, const void* p_clamp_min /* = NULL */, const void* p_clamp_max /* = NULL */);
CIMGUI_API bool                 igTempInputIsActive(ImGuiID id);
CIMGUI_API ImGuiInputTextState* igGetInputTextState(ImGuiID id);                                                                                                           // Get input text state if active
CIMGUI_API void                 igSetNextItemRefVal(ImGuiDataType data_type, void* p_data);
CIMGUI_API bool                 igIsItemActiveAsInputText(void);                                                                                                           // This may be useful to apply workaround that a based on distinguish whenever an item is active as a text input field.
...
// Plot
CIMGUI_API int igPlotEx(ImGuiPlotType plot_type, const char* label, float (*values_getter)(void* data, int idx), void* data, int values_count, int values_offset, const char* overlay_text, float scale_min, float scale_max, ImVec2 size_arg);
...
CIMGUI_API void igShadeVertsLinearUV(ImDrawList* draw_list, int vert_start_idx, int vert_end_idx, ImVec2 a, ImVec2 b, ImVec2 uv_a, ImVec2 uv_b, bool clamp);
CIMGUI_API void igShadeVertsTransformPos(ImDrawList* draw_list, int vert_start_idx, int vert_end_idx, ImVec2 pivot_in, float cos_a, float sin_a, ImVec2 pivot_out);
...
// Debug Tools
CIMGUI_API void  igDebugAllocHook(ImGuiDebugAllocInfo* info, int frame_count, void* ptr, size_t size);                      // size >= 0 : alloc, size = -1 : free
CIMGUI_API void  igDebugDrawCursorPos(void);                                                                                // Implied col = IM_COL32(255, 0, 0, 255)
CIMGUI_API void  igDebugDrawCursorPosEx(ImU32 col /* = IM_COL32(255, 0, 0, 255) */);
CIMGUI_API void  igDebugDrawLineExtents(void);                                                                              // Implied col = IM_COL32(255, 0, 0, 255)
CIMGUI_API void  igDebugDrawLineExtentsEx(ImU32 col /* = IM_COL32(255, 0, 0, 255) */);
CIMGUI_API void  igDebugDrawItemRect(void);                                                                                 // Implied col = IM_COL32(255, 0, 0, 255)
CIMGUI_API void  igDebugDrawItemRectEx(ImU32 col /* = IM_COL32(255, 0, 0, 255) */);
CIMGUI_API void  igDebugTextUnformattedWithLocateItem(const char* line_begin, const char* line_end);
CIMGUI_API void  igDebugLocateItem(ImGuiID target_id);                                                                      // Call sparingly: only 1 at the same time!
CIMGUI_API void  igDebugLocateItemOnHover(ImGuiID target_id);                                                               // Only call on reaction to a mouse Hover: because only 1 at the same time!
...
CIMGUI_API void  igDebugNodeTexture(ImTextureData* tex, int int_id);                                                        // Implied highlight_rect = NULL
CIMGUI_API void  igDebugNodeTextureEx(ImTextureData* tex, int int_id, const ImFontAtlasRect* highlight_rect /* = NULL */);  // ID used to facilitate persisting the "current" texture.
...
CIMGUI_API void  igDebugRenderViewportThumbnail(ImDrawList* draw_list, ImGuiViewportP* viewport, ImRect bb);

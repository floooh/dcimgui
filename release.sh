...
mkdir -p src
python3 dear_bindings/dear_bindings.py -o src/cimgui --custom-namespace-prefix ig --include imgui/imgui.h imgui/imgui_internal.h
cp imgui/*.h imgui/*.cpp imgui/LICENSE.txt src/

# docking branch
mkdir -p src-docking
python3 dear_bindings/dear_bindings.py -o src-docking/cimgui --custom-namespace-prefix ig --include imgui-docking/imgui.h imgui-docking/imgui_internal.h
